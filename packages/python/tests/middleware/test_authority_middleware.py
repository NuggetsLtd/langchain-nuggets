...
class TestProofVerificationDefaultOn:
    ...
    def test_verifiable_proof_passes_through(self, rsa_keypair, mock_request, mock_handler):
        from langchain_nuggets.middleware.proof_verification import _reset_jwks_cache
        ...
        # The middleware pins to {api_url}/.well-known/jwks.json.
        ...
        proof_jws = jwt.encode(
            {
                ...
                "decision": "ALLOW",
                "iat": int(time.time()),
                "iss": "did:web:whatever.test:ignored",
            },
            portal_pem,
            algorithm="RS256",
            headers={"kid": kid},
